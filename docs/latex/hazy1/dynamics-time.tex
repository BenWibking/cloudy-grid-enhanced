...
The command \cdCommand{stop time when temperature below 10000}
...
integration time.
The syntax is \cdCommand{stop time $<$value$>$}, where the value may be set as
with the \cdCommand{age} command, Section \ref{sec:AgeCommand}.
For example,
%
\begin{verbatim}
stop time 25 Myr
